...
namespace BiotechPatch
{
    public class BiotechPatchMod : Mod
    {
        ...
        public BiotechPatchMod(ModContentPack content) : base(content)
        {
            ...
            {
                harmony.Patch(AccessTools.TypeByName("AchtungMod.Colonist").Method("UpdateOrderPos", new[] { typeof(Vector3), typeof(Predicate<IntVec3>) }), null, null, typeof(CompatibilityPatch_AchtungMod_Colonist).Method(nameof(CompatibilityPatch_AchtungMod_Colonist.Transpiler)));
            }
